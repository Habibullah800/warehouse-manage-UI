...
const Myitem = ({ item, handleDelete }) => {
    ...
    const { name, price, description, img, quantity, supplier, email } = item;
            ...
            <div class="card w-[340px] bg-base-100 shadow-xl mt-4 mx-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                        ...
                        <div class="badge badge-outline h-7 hover:bg-lime-200 flex items-center justify-center bg-[#EDF9EF] font-semibold hover:text-black text-[#4cd137] mx-auto">email: {email}</div>
                    </div>



                    <button onClick={() => handleDelete(item._id)} class="hover:bg-[#EA2027] flex items-center justify-center rounded-b-xl bg-lime-200 mt-2 h-9 font-bold hover:text-black text-[#4cd137]"  >Delete Item</button>
